  ...
  const handleShare = async (tournament: TournamentCard, type: 'ticket' | 'tournament') => {
    ...
    try {
      if (navigator.share) {
        ...
        addToast({
          title: 'Lien partagé !',
          message: 'Le lien a été partagé avec succès',
          type: 'success'
        });
      } else {
    ...
    switch (action) {
      ...
      case 'publish':
        addToast({
          ...
          message: 'Votre tournoi est maintenant visible par tous',
          type: 'success'
        });
        break;
      case 'results':
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className="inline-flex items-center justify-center rounded-full h-8 w-8 overflow-hidden ring-1 ring-inset ring-neutral-700/80"
              >
                <img
                  alt="Avatar"
      ...
      <footer className="border-t border-neutral-900/80">
        <div className="mx-auto max-w-6xl px-4">
          <div className="py-6 text-xs text-neutral-500 flex items-center justify-between">
            <span>© 2025 FreeFire Tournaments</span>
